...
Loop, {
	...
	WinWaitClose, %SongArtistAndTitleFromSpotify% ahk_exe Spotify.exe
	WinGetTitle, SongArtistAndTitleFromSpotify , ahk_id %SpotifyWindowID%
	If (SongArtistAndTitleFromSpotify = "Spotify Free") {
		SendData("VolpesBot", "SpotifySongChanged,SendDataVar1,,SendDataVar2,Nothing")
		}
	Else if (SongArtistAndTitleFromSpotify = "Advertisement") {
		SendData("VolpesBot", "SpotifySongChanged,SendDataVar1,,SendDataVar2,Nothing")
		}
