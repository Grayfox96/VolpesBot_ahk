PrintArray(Array, Display=0, Level=0) {
	Global PrintArray
	...
	Gui, PrintArray:Add, Edit, x0 y0 w450 h350 vPrintArray ReadOnly HScroll, %Output%
	Gui, PrintArray:Show, w450 h350, PrintArray
...
> "h" ; similar to above but directrly proportional to height
	...
	License:
		- Version 4.60a <https://ahknet.autohotkey.com/~Titan/#anchor>
		- Simplified BSD License <https://ahknet.autohotkey.com/~Titan/license.txt>
*/
Anchor(i, a = "", r = false) {
