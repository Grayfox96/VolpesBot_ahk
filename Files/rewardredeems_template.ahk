...
If (TagsArray["custom-reward-id"] = CustomRewardId1) {
...
Else if (TagsArray["custom-reward-id"] = CustomRewardId2) {
	}
Else if (TagsArray["custom-reward-id"] = CustomRewardId3) {
	}
Else if (TagsArray["custom-reward-id"] = CustomRewardId4) {
	}
